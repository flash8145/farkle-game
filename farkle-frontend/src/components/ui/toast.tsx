...
function ToastItem({ toast, onRemove }: ToastItemProps) {
  ...
  const baseStyles = 'backdrop-blur-md border-l-4 rounded-lg shadow-xl p-4 flex items-start gap-3 transition-all duration-300';
  const animationClass = isExiting ? 'opacity-0 translate-x-full' : 'opacity-100 translate-x-0';

  return (
    <div className={`${baseStyles} ${styles[toast.type]} ${animationClass}`}>
